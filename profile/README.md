# 🏴󠁧󠁢󠁷󠁬󠁳󠁿 NHS Wales National Data Resource (NDR)

> **Adnodd Data Cenedlaethol Cymru** — connecting and consolidating health and social care data across Wales.

---

## About the National Data Resource

The **National Data Resource (NDR)** is a programme led by [Digital Health and Care Wales (DHCW)](https://dhcw.nhs.wales/our-programmes/national-data-resource1/), funded by the Welsh Government. Our mission is to build a secure, unified national platform that brings together health and social care data from across Wales — enabling better decisions, better care, and better outcomes for the people of Wales.
...
Repositories in this organisation include:

- **FHIR interoperability profiles** for NHS Wales (`NHSWales-fhir-profiles`)
- **Analytics templates and reusable code** for health data analysis
- **Data pipeline and integration components** supporting the NDR platform
- **Standards and guidance** to support consistent analytical practice across Wales
...
*Part of [Digital Health and Care Wales (DHCW)](https://dhcw.nhs.wales/) — driving digital transformation across NHS Wales.*
